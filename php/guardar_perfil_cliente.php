...
<br><br><br>
    ...
    $client=$db->seleccionar($cadena2);
    foreach($client as $value)
    {
    $cadena3="CALL insertar_clientes($value->cve,'$t_cliente','$direccion');";
    $db->ejecutaSQL($cadena3);
    // $db->verificaLogin($correo, $contraseña);
    //  $db->desconectarDB();
    }
    echo "<div class='alert alert-success'> <br><br><br> <h1>CUENTA CREADA</h1> <br> Puedes iniciar sesion aqui <a href='../inicio_de_sesion.php'>AQUÍ</a><br><br><br>  </div>";
    }
    ?>
    </div>
